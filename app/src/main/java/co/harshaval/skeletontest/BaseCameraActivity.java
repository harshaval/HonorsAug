...
// A class that is the base camera activity in use for the application which provides the view and anchors for the application
...
public abstract class BaseCameraActivity extends AppCompatActivity implements OnImageAvailableListener {
    ...
    protected synchronized void backgroundRun(final Runnable r) {
        if (handler != null) {
            handler.post(r);
        }
    }
